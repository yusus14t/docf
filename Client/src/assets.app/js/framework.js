  ...
  var MedboardFramework = (function(){
    ...
    function quickBarConfigure(){
      ...
      $('.ms-configure-qa').on('click', function(e){
        e.preventDefault();
        $('.ms-quick-bar-item a').removeAttr('data-bs-toggle');
        quickBarReset();
        ...
        if( stateSort == 'disable' ){
          $('.ms-quick-bar-item a').attr('data-bs-toggle', 'tab');
          quickBarSaveLocal();
        }
    ...
    function addTaskBlockQB(){
      $(".ms-add-task-block").on('submit', function(e){
        ...
        $(".ms-quickbar-container .ms-todo-list").prepend(
          ...
          '<h6 class="ms-card-title">'+ $("#task-block").val() +'</h6> <button data-bs-toggle="tooltip" data-placement="left" title="Add a Task to this block" class="ms-add-task-to-block ms-btn-icon float-end">' +
          '<i class="material-icons">add</i> </button> </div> <div class="ms-card-body"> <ul class="ms-list ms-task-block"> </ul></div>' +
          '<div class="ms-card-footer clearfix"><a href="#" class="text-disabled me-2"> <i class="flaticon-archive"> </i> Archive </a><a href="#" class="text-disabled ms-delete-trigger float-end">' +
    ...
    function addTaskBlockApp(){
      $(".ms-add-task-block-2").on('submit', function(e){
        ...
        $(".ms-todo-list").prepend(
          ...
          '<h6 class="ms-card-title">'+ $("#task-block-2").val() +'</h6> <button data-bs-toggle="tooltip" data-placement="left" title="Add a Task to this block" class="ms-add-task-to-block ms-btn-icon float-end">' +
          '<i class="material-icons">add</i> </button> </div> <div class="ms-card-body"> <ul class="ms-list ms-task-block"> </ul></div>' +
          '<div class="ms-card-footer clearfix"><a href="#" class="text-disabled me-2"> <i class="flaticon-archive"> </i> Archive </a><a href="#" class="text-disabled ms-delete-trigger float-end">' +
