...
const Clinics = ({ source }) => {
    ...
    const deleteClinic = async ( _id ) => {
        try{
            ...
            setClinics( old => old.filter( clinic => clinic._id !== _id ))
    ...
    return (
        ...
        <div className="ms-content-wrapper mx-2 ">
                                    ...
                                    <div className="ms-card-body">
                                        <div className="media mb-0 fs-14">
                                            <div className="me-2 align-self-center">
                                                <img src={clinic?.photo ? getFullPath(clinic.photo) : NO_PHOTO} className="ms-img-round" alt="people" />
                                            </div>
                                            <div className="media-body">
                                                ...
                                                <p className="fs-12 my-1 text-disabled">{clinic?.address || '-'}</p>
                                                <h6 className="mt-0">
            ...
            { deleteModal && <Modal
                ...
                data={clinic}
                callback={() => deleteClinic(clinic?._id) }
            >
