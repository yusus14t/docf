    ...
    <div>
      <div className="ms-content-wrapper">
        <div
          ...
          class="ms-panel-header ms-panel-custome d-flex justify-space-between mb-2"
        >
          <div>
            <h6>Dashboard</h6>
          </div>
                ...
                <div class="ms-card-body media">
                  <div class="media-body">
                    ...
                    <div className="d-flex justify-content-start">
                      <div className="ms-card-change text-dark me-3">
                        <span className="fs-07 text-white">Today </span>45
                      </div>
                      <div className="ms-card-change text-dark ">
                        <span className="fs-07 text-white">Total </span>34
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <ul class="ms-followers ms-list ms-scrollable ps">
                  {[1, 2, 3, 4, 5, 6, 7, 8].map((e, i) => (
                    <li class="ms-list-item media">
                      <img
                        src={image}
                        class="ms-img-small ms-img-round"
                        alt="people"
                      />
