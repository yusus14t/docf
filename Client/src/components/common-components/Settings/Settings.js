...
const Settings = () => {
    ...
    const [doctor, setDoctor] = useState(
      JSON.parse(localStorage.getItem("createDoctor")) || {}
    );
              ...
              <div class="media fs-14" style={{ marginBottom: "0" }}>
                ...
                <div class="media-body">
                  <div className="d-flex justify-content-between">
                    ...
                    <div>
                      <FontAwesomeIcon
                        className="ms-text-ligth mx-3 cursor-pointer"
                        icon={faPencil}
                      />
                      <FontAwesomeIcon
                        className="ms-text-ligth cursor-pointer"
                        icon={faTrash}
                        onClick={() =>
                          setDoctors((old) =>
                            old.filter((d) => d.phone !== doc.phone)
                          )
                        }
                      />
                    </div>
                  ...
                  <h6 class="mt-2">
                    ...
                    {doctor.name || "Jawahar Lal Nehru Hospital"}
                  </h6>
                </div>
              </div>
            </div>
            ...
            <div className="col-md-6 mb-3">
              ...
              <div className="input-group">
                <textarea
                  type="text"
                  className={`form-control ${
                    errors.qualification ? "border-danger" : ""
                  }`}
