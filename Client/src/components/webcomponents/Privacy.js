    ...
    <>
      ...
      <h2 className='text-center bg-success text-white p-2'>Privacy Policy</h2>
        ...
        <ol type="i">
          ...
          <li>How and to whom Doctor Time will reveal such data.</li>
        </ol>
        ...
        <p style={{ textAlign: "justify" }}>
          ...
          assortment of such data by Doctor Time. Without bias to the
        ...
        <ol type="i" start="vii">
          ...
          <li>
            ...
            <p>
              The data gathered from you by Doctor Time might comprise
          ...
          <li>
            call information records. Doctor Time will be allowed to utilize,
        ...
        <div>
          ...
          <p style={{ textAlign: "justify" }}>
            ...
            to discontinue the Services provided by Doctor Time immediately.
          </p>
          <p style={{ textAlign: "justify" }}>
            3.1.2 An indicative list of information that Doctor Time may require
            you to provide to enable your use of the Services is provided in the
            Schedule annexed to this Privacy Policy.
          </p>
          <p style={{ textAlign: "justify" }}>
            3.1.3 All the information provided to Doctor Time by a User,
            including Personal Information or any Sensitive Personal Data or
            Information, is voluntary. You understand that Doctor Time may use
            ...
            transaction. Doctor Time also reserves the right to use
          </p>
          <p>
          ...
          <p style={{ textAlign: "justify" }}>
            ...
            capacity to get special proposals from Doctor Time, is
            discretionary. Doctor Time may, in future, incorporate other
            discretionary solicitations for data from the patient to assist with
            Doctor Time to alter the Site to convey customized data to the
            patients.
          </p>
          <p style={{ textAlign: "justify" }}>
            3.1.13 Doctor Time doesn't practice command over the locales showed
            ...
            individual data from the patients for which Doctor Time isn't
            dependable or responsible. As needs be, Doctor Time makes no
            portrayals concerning the privacy practices or arrangements of such
            outsiders or terms of purpose of such sites, nor Doctor Time ensure
            ...
            this completely in spite of the obvious danger. Doctor Time urges
          ...
          <p style={{ textAlign: "justify" }}>
            ...
            including any mediators or heads, are not approved Doctor Time
            delegates or specialists, and their perspectives or articulations
            don't be guaranteed to mirror those of Doctor Time, and they are not
            approved to tie Doctor Time to any agreement. Doctor Time thusly
          ...
          <p style={{ textAlign: "justify" }}>
            3.1.15 Doctor Time doesn't gather data about the guests of the Site
            ...
            to under the Terms of Purpose for Doctor Time to deliver the
            Administrations actually).
          </p>
          <p style={{ textAlign: "justify" }}>
            3.1.16 Doctor Time keeps a severe "No-Spam" policy, and that implies
            that Doctor Time doesn't mean to sell, lease or in any case give
            your email address to an outsider without your assent.
          </p>
          <p style={{ textAlign: "justify" }}>
            3.1.17 Doctor Time has carried out best global market practices and
          ...
          <p style={{ textAlign: "justify" }}>
            3.1.18 Doctor Time carries out sensible privacy practices and
            ...
            regarding the data being gathered and the idea of Doctor Time's
            business.
          </p>
          <p style={{ textAlign: "justify" }}>
            3.1.19 Doctor Time treats your right to privacy exceptionally in a
            ...
            or when Doctor Time, in its only caution, considers it significant
          ...
          <p style={{ textAlign: "justify" }}>
            ...
            Data to Doctor Time, bombing which they are expected to leave the
            Administrations, including the Site right away.
          </p>
          <p style={{ textAlign: "justify" }}>
            3.2.3 Practitioners' actually recognizable data, which they decide
            to give to Doctor Time, is utilized to help the Professionals
            portray and distinguish themselves. This data is only claimed by
            Doctor Time You will be the proprietor of your data and you agree to
            Doctor Time gathering, utilizing, handling as well as unveiling this
            data for the reasons hereinafter expressed. Doctor Time might
            ...
            offshoots. Doctor Time additionally maintains all authority to
          ...
          <p>
            3.2.4 Doctor Time naturally empowers the posting of Experts' data on
            ...
            recorded on the Site isn't created by Doctor Time and is given to
            Doctor Time by Experts who wish to enroll themselves on the Site or
          ...
          <p>
            3.2.5 Doctor Time may likewise show data for Experts who have not
            joined or enlisted for the Administrations, given that the Doctor
            have agreed to Doctor Time gathering, handling as well as unveiling
            their data on the Site. Such Doctor are checked by Doctor Time or
            its partners, and Doctor Time bends over backward to catch precise
            data for such Professionals. Be that as it may, Doctor Time embraces
          ...
          <p style={{ textAlign: "justify" }}>
            ...
            Information or Data to Doctor Time, bombing which they are expected
            to leave the Doctor Time right away.
          </p>
          <p style={{ textAlign: "justify" }}>
            ...
            sending an email to privacy@doctortime.in, ask whether Doctor Time
            is in control of your own information, and you may likewise require
            Doctor Time to erase and obliterate all such data.
          </p>
          <p style={{ textAlign: "justify" }}>
            ...
            Doctor Time from End-patients, (for example, examples of usage
            portrayed above) and is only possessed by Doctor Time. Specialist
            ...
            Specifically, Doctor Time maintains with it the authority to utilize
          ...
          <p style={{ textAlign: "justify" }}>
            3.3.5 Doctor Time will speak with the End-patients through email,
          ...
          <p style={{ textAlign: "justify" }}>
            3.3.6 At times, Doctor Time leads a patients review to gather data
            ...
            mysterious. Likewise, Doctor Time might offer challenges to
            qualifying End-patients in which we request contact and segment
            data, for example, name, email address and street number. The
            segment data that Doctor Time gathers in the enrollment cycle and
            through reviews is utilized to assist with doctor Time work on its
            Administrations to address the issues and inclinations of
            End-patients.
          </p>
          <p style={{ textAlign: "justify" }}>
            3.3.7 Doctor Time might track electronic correspondences and calls
          ...
          <p style={{ textAlign: "justify" }}>
            3.3.8 the Doctor Time representatives and information processors,
            ...
            Information and Data. Doctor Time has set up systems and
          ...
          <p style={{ textAlign: "justify" }}>
            3.3.9 Doctor Time may likewise uncover or move End-patients' own and
            other data given by a patient, to an outsider as a feature of
            revamping or an offer of the resources of a Doctor Time enterprise
            division or organization. Any outsider to which Doctor Time moves or
          ...
          <p style={{ textAlign: "justify" }}>
            ...
            Administrations, Doctor Time might give their Own Data to outsider
            workers for hire who work for or with Doctor Time to give
            End-patients such Administrations, to assist with doctor Time speak
          ...
          <p style={{ textAlign: "justify" }}>
            ...
            gathered by Doctor Time from any relaxed guests of this site, who
          ...
          <p style={{ textAlign: "justify" }}>
            ...
            clear all impermanent treats introduced by Doctor Time. All guests,
          ...
          <p style={{ textAlign: "justify" }}>
            ...
            eagerly presented any private information or data to Doctor Time
          ...
          <p>
            4.1 Your Individual Data is kept up with by Doctor Time in
            electronic structure on its hardware, and on the gear of its
            workers. Such data may likewise be switched over completely to
            actual structure now and again. Doctor Time avoids potential risk to
            ...
            the idea of Doctor Time's business.
          </p>
          <p>
            4.2 No head at Doctor Time will know about your secret phrase. You
            ...
            when wrapped up. Doctor Time attempts no risk for any unapproved
            ...
            Doctor Time by sending an email to support@doctortime.in You will be
            responsible to reimburse Doctor Time because of any misfortune
            endured by it because of such unapproved utilization of your record
            and secret phrase.
          </p>
          <p>
            4.3 Doctor Time makes all patient data open to its workers,
          ...
          <p>
            4.5 Part of the usefulness of the Doctor Time is helping the
            patients to get to data connecting with them. Doctor Time may,
            thusly, hold and present all such records to the pertinent patients,
            or to their PCPs.
          </p>
          <p>
            4.6 Not with standing the abovementioned, Doctor Time isn't
            ...
            control of Doctor Time including however not restricted to,
          ...
          <p>
            Doctor Time might refresh this Protection policy out of the blue,
            regardless of early notification. In the occasion there are
            tremendous changes in the manner Doctor Time treats patient's by and
            ...
            in any case, Doctor Time's ongoing Protection policy applies to all
            data that Doctor Time has about you and your record.
          </p>
          <p>
          ...
          <p>
            Doctor Time firmly urges guardians and gatekeepers to oversee the
            ...
            online without parental consent. Albeit the Doctor Time Site and
            Administrations are not expected for use by minors, Doctor Time
          ...
          <p>
            ...
            (ii) agree to Doctor Time utilizing, gathering, handling as well as
          ...
          <p>
            ...
            Site or ' Doctor Time' versatile application:
          </p>
          <p style={{ textAlign: "justify" }}>
          ...
          <p style={{ textAlign: "justify" }}>
            ...
            administration given by Doctor Time, and the records of such calls
            ...
            recording of such call, Doctor Time thusly holds the right not to
          ...
          <p style={{ textAlign: "justify" }}>
            ...
            the Site or 'Doctor Time' mobile application (i.e., 'Visitor' End
            patient):
          </p>
          <p style={{ textAlign: "justify" }}>
          ...
          <p style={{ textAlign: "justify" }}>
            Against each Expert recorded on Doctor Time.in, you might see a
            'show number' choice. At the point when you pick this choice, you
            decide to call the number through a free communication
            administration given by Doctor Time, and the records of such calls
            are recorded and put away in Specialist Deadbeats. Such calls will
            ...
            calls and your agree to such accounts which are managed according to
            the privacy policy. In the event that you decide not to agree to the
            recording of such a call, Doctor Time thusly saves the right not to
            give you with the Administrations to which such Private Data is
          ...
          <p style={{ textAlign: "justify" }}>
            ...
            Site or ' Doctor Time' mobile application by enrolling for a record:
          </p>
          <p style={{ textAlign: "justify" }}>
            ...
            record. Doctor Time might send email or potentially SMS affirmations
          ...
          <p style={{ textAlign: "justify" }}>
            ...
            Site or ' Doctor Time' versatile application without enrolling for a
            record:
          </p>
          <p style={{ textAlign: "justify" }}>
            ...
            mentioned by any of Doctor Time's workers or specialists who reach
            you face to face or by phone. In such occasion, Doctor Time will
            keep up with this data if and until you decide to enlist for a
            record, for which Doctor Time might reach you every once in a while.
            Doctor Time will, after such data is gathered from you, send you an
            ...
            recorded on the Site, kindly illuminate Doctor Time quickly at
          ...
          <p style={{ textAlign: "justify" }}>
            ...
            furnish Doctor Time with data in regards to your [name, portable
            number, email address, computerized signature], and such other data
            as mentioned by Doctor Time on the Beam and additionally Tab
            ...
            Doctor Time won't get to the said advanced signature for some other
            reason for any reason. Upon enlistment, Doctor Time will get to
          ...
          <p style={{ textAlign: "justify" }}>
            Doctor Time maintains all authority to expand and pull out 'ABS'
            ...
            insinuated to you by Doctor Time.
          </p>
          <p style={{ textAlign: "justify" }}>
          ...
          <p>6 .Practitioners utilizing the ' Doctor Time Reach' item:</p>
          <p style={{ textAlign: "justify" }}>
            You will be expected to make a record and might be expected to
            furnish Doctor Time with data in regards to your [name, versatile
            number, email address], and such other data as mentioned by Doctor
            Time on the ' Doctor Time Reach' Professional enrollment page, to
          ...
          <p style={{ textAlign: "justify" }}>
            ...
            furnish Doctor Time with data, for example, your name, portable
            number, email address, and other data as mentioned by Doctor Time on
            the Doctor Time Counsel enrollment page to finish your registration.
          </p>
        </div>
      </div>
    </>
