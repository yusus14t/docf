(function($) {
 ...
 /* Engaged Users */
  ...
  gradientStrokeengagedUsers.addColorStop(0, '#00acb1');

  var gradientFillengagedUsers = engagedUsersCtx.createLinearGradient(0, 0, 0, 450);
  gradientFillengagedUsers.addColorStop(0, "rgba(0, 172, 177, 0.50)");
  ...
  gradientStrokepageImpressions.addColorStop(0, '#00acb1');

  var gradientFillpageImpressions = pageImpressionsCtx.createLinearGradient(0, 0, 0, 450);
  gradientFillpageImpressions.addColorStop(0, "rgba(0, 172, 177, 0.50)");
  ...
  // Overview slider
    ...
    gradientStroke.addColorStop(0, '#00acb1');

    var gradientFill = ctx.createLinearGradient(0, 0, 0, 450);
    gradientFill.addColorStop(0, "rgba(0, 172, 177, 0.50)");
    gradientFill.addColorStop(1, "rgba(0, 172, 177, 0.04)");
    ...
    var lineChart = new Chart(ctx, {
      ...
      options: {
        ...
        gradientStroke2.addColorStop(0, '#00acb1');

        var gradientFill2 = ctx2.createLinearGradient(0, 0, 0, 450);
        gradientFill2.addColorStop(0, "rgba(0, 172, 177, 0.50)");
      ...
      gradientStrokeZCash.addColorStop(0, '#00acb1');

      var gradientFillZCash = zCashCtx.createLinearGradient(0, 0, 0, 450);
      gradientFillZCash.addColorStop(0, "rgba(0, 172, 177, 0.50)");
    ...
    gradientStrokePeercoin.addColorStop(0, '#00acb1');

    var gradientFillPeercoin = peerCoinCtx.createLinearGradient(0, 0, 0, 450);
    gradientFillPeercoin.addColorStop(0, "rgba(0, 172, 177, 0.50)");
